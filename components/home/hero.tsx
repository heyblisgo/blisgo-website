export const Hero = () => {
  return (
    <section className="xl:mx-auto xl:w-[1280px] mx-4 md:mx-6 relative rounded-lg p-4 pb-3 md:pb-6 md:pt-8 md:pl-10 bg-[linear-gradient(242.94deg,#015F27_0%,#6BB89C_100%)] bg-white">
